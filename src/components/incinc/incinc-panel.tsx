...
export function IncincPanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    <motion.div
      ...
      className="glass fixed bottom-[calc(10.5rem+env(safe-area-inset-bottom))] right-4 z-50 flex h-[min(640px,calc(100vh-14.5rem))] w-[min(400px,calc(100vw-2rem))] flex-col overflow-hidden rounded-3xl md:bottom-24 md:right-6 md:h-[min(640px,calc(100vh-9rem))]"
      role="dialog"
