...
import { Star, Share2, Flag, MessageSquarePlus, History, Check } from "lucide-react";
 ...
 *  Favorite · Share · History · Report · Feedback. No per-tool wiring needed. */
export function ToolUtilityBar({ slug, name }: { slug: string; name: string }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-1.5">
      ...
      <Link href="/dashboard" className="inline-flex items-center gap-1.5 rounded-lg border border-border px-2.5 py-1.5 text-xs font-medium hover:bg-secondary">
