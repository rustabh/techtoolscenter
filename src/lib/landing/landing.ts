...
const resumeVariants: { slug: string; label: string; use: string; skillsNote: string; example: string }[] = [
  ...
  { slug: "resume-builder-for-project-managers", label: "Project Managers", use: "lead with the programs you've delivered, budgets you've managed and measurable delivery outcomes", skillsNote: "List methodologies (Agile, Scrum, Waterfall), certifications (PMP, CSM) and tools (Jira, Asana, MS Project) recruiters scan for first", example: "A PM listing a $2M platform migration delivered two weeks ahead of schedule" },
  { slug: "resume-builder-for-hr-professionals", label: "HR Professionals", use: "highlight the hiring pipelines you've built, retention improvements and HR systems you've managed", skillsNote: "List HRIS tools (Workday, SAP SuccessFactors), certifications (SHRM, HRCI) and specific programs you've run (onboarding, DEI, performance reviews)", example: "An HR manager listing a revamped onboarding process that cut new-hire attrition by 20%" },
  { slug: "resume-builder-for-mechanical-engineers", label: "Mechanical Engineers", use: "showcase the systems you've designed, manufacturing processes you've improved and the CAD tools you use", skillsNote: "List CAD/CAE software (SolidWorks, AutoCAD, ANSYS), certifications and the scale of projects you've delivered", example: "A mechanical engineer listing a redesigned assembly-line component that cut production time by 18%" },
  { slug: "resume-builder-for-doctors", label: "Doctors", use: "lead with your clinical specialisation, residency and board certifications the way hospitals and clinics screen for first", skillsNote: "List your medical licence, board certifications, specialisation and any research or publications prominently near the top", example: "A resident physician listing board certification progress and a case-load specialisation in cardiology" },
  { slug: "resume-builder-for-lawyers", label: "Lawyers", use: "highlight your bar admission, practice areas and notable case or deal experience", skillsNote: "List your bar admission(s), practice area specialisation and quantify outcomes where you can (cases won, deal size, clients served)", example: "An associate listing bar admission and a due-diligence role on a ₹50 crore acquisition" },
  { slug: "resume-builder-for-ui-ux-designers", label: "UI/UX Designers", use: "lead with your portfolio, design process and measurable usability outcomes rather than just tools", skillsNote: "List design tools (Figma, Sketch, Adobe XD) and link directly to your portfolio — recruiters expect to click through and see actual work", example: "A UX designer listing a checkout redesign that cut cart abandonment by 22%" },
  { slug: "resume-builder-for-pharmacists", label: "Pharmacists", use: "highlight your licence, clinical experience and the systems or specialisations you're trained in", skillsNote: "List your pharmacy licence/registration, any clinical specialisation, and dispensing or inventory systems you've used", example: "A pharmacist listing licensure and experience managing a high-volume retail dispensary" },
  { slug: "resume-builder-for-product-managers", label: "Product Managers", use: "lead with shipped products, measurable outcomes and how you worked across engineering, design and business", skillsNote: "Quantify impact (adoption, revenue, retention) and list the tools (Jira, Figma, analytics platforms) and methodologies you've used", example: "A PM listing a feature launch that grew weekly active users by 18%" },
  { slug: "resume-builder-for-content-writers", label: "Content Writers", use: "showcase your published work, niches you write for and measurable content performance", skillsNote: "Link to a portfolio or published samples, and list content types (SEO articles, technical docs, copywriting) and any measurable results (traffic, rankings)", example: "A content writer listing an SEO article series that reached page-one rankings for 12 keywords" },
  { slug: "resume-builder-for-bank-po-and-government-exams", label: "Bank PO & Government Exam Aspirants", use: "present your academic record, exam scores and any relevant certifications in the clean, formal format banks and government recruiters expect", skillsNote: "List your exam scores (if applicable), academic percentages, and any banking or finance-related certifications clearly near the top", example: "A candidate listing IBPS PO prelims/mains scores alongside a B.Com degree and a certificate in banking fundamentals" },
  { slug: "resume-builder-for-electrical-engineers", label: "Electrical Engineers", use: "highlight the systems you've designed, standards you work to and the tools you use", skillsNote: "List software (AutoCAD Electrical, MATLAB, PLC platforms), relevant certifications and the scale/voltage class of projects you've handled", example: "An electrical engineer listing a panel design project for a 500kW industrial installation" },
  { slug: "resume-builder-for-business-analysts", label: "Business Analysts", use: "lead with the requirements you've gathered, processes you've mapped and measurable business outcomes", skillsNote: "List tools (SQL, Excel, Visio, Jira) and quantify impact — process time saved, requirements delivered, stakeholders aligned", example: "A business analyst noting a requirements overhaul that cut project rework by 25%" },
  { slug: "resume-builder-for-architects", label: "Architects", use: "showcase your design portfolio, project scale and the software you're fluent in", skillsNote: "List design software (AutoCAD, Revit, SketchUp), licensure status and the type/scale of projects (residential, commercial) you've delivered", example: "An architect listing a mixed-use commercial project taken from concept through municipal approval" },
  { slug: "resume-builder-for-customer-service-representatives", label: "Customer Service Representatives", use: "highlight resolution metrics, customer satisfaction scores and the systems you've worked in", skillsNote: "Quantify performance (CSAT score, resolution time, tickets handled) and list the helpdesk/CRM systems you're experienced with", example: "A support rep noting a 96% CSAT score across 50+ tickets resolved weekly" },
  { slug: "resume-builder-for-devops-engineers", label: "DevOps Engineers", use: "lead with the infrastructure you've automated, uptime you've maintained and the toolchain you use", skillsNote: "List tools (Docker, Kubernetes, Terraform, CI/CD platforms) and quantify impact — deployment frequency, uptime, incidents reduced", example: "A DevOps engineer listing a CI/CD pipeline overhaul that cut deployment time from 2 hours to 10 minutes" },
  { slug: "resume-builder-for-data-scientists", label: "Data Scientists", use: "lead with the models you've shipped, the business impact of your analysis and the ML stack you work in", skillsNote: "List frameworks (Python, PyTorch/TensorFlow, SQL) and quantify impact — accuracy gains, revenue influenced, time saved by a shipped model", example: "A data scientist listing a churn-prediction model that cut customer attrition by 15%" },
  { slug: "resume-builder-for-cybersecurity-analysts", label: "Cybersecurity Analysts", use: "highlight the incidents you've handled, certifications you hold and the security tools you're fluent in", skillsNote: "List certifications (CEH, Security+, CISSP), tools (SIEM platforms, Wireshark, Nessus) and quantify impact — incidents resolved, vulnerabilities closed", example: "A SOC analyst listing 200+ triaged alerts monthly and a phishing-simulation program that cut click rates by 40%" },
  { slug: "resume-builder-for-social-media-managers", label: "Social Media Managers", use: "lead with follower growth, engagement rates and campaigns you've run across platforms", skillsNote: "List platforms managed, tools (Hootsuite, Canva, Meta Business Suite) and quantify outcomes — follower growth, engagement rate, campaign reach", example: "A social media manager listing a campaign that grew Instagram followers by 25,000 in a quarter" },
  { slug: "resume-builder-for-qa-test-engineers", label: "QA / Test Engineers", use: "highlight the test coverage you've built, bugs you've caught before release and automation frameworks you use", skillsNote: "List tools (Selenium, Cypress, Postman, JIRA) and quantify impact — test coverage percentage, bugs caught pre-release, regression time saved", example: "A QA engineer listing an automated test suite that cut regression testing time from 3 days to 4 hours" },
  { slug: "resume-builder-for-administrative-assistants", label: "Administrative Assistants", use: "highlight the schedules, budgets and office systems you've managed to keep an organisation running smoothly", skillsNote: "List software (MS Office, Google Workspace, calendar/scheduling tools) and quantify scope — calendars managed, budgets tracked, events coordinated", example: "An executive assistant listing calendar management for 3 senior executives and a travel budget of ₹15 lakh annually" },
  { slug: "resume-builder-for-chartered-accountants", label: "Chartered Accountants", use: "lead with your CA credential, articleship experience and the specific audit, tax or advisory work you've handled", skillsNote: "List your CA membership number/status, specialisation (audit, taxation, GST, forensic) and software (Tally, SAP, Zoho Books) prominently near the top", example: "A newly qualified CA listing articleship experience auditing 15+ SME clients and GST return filings" },
  { slug: "resume-builder-for-full-stack-developers", label: "Full Stack Developers", use: "showcase both your frontend and backend stack together with shipped, end-to-end projects", skillsNote: "List your stack across both layers (React/Next.js, Node/Django, databases) and link to a live project or GitHub rather than just naming technologies", example: "A full stack developer listing an end-to-end e-commerce app built solo, from database schema to deployed frontend" },
  { slug: "resume-builder-for-digital-marketing-specialists", label: "Digital Marketing Specialists", use: "lead with the specific channels you've run (SEO, paid ads, email) and the measurable growth each one drove", skillsNote: "List platforms and certifications (Google Ads, Meta Blueprint, HubSpot) and quantify results per channel — CTR, CAC, ROAS — rather than general marketing duties", example: "A digital marketer listing a Google Ads campaign that cut CAC by 30% while scaling spend 2x" },
  { slug: "resume-builder-for-cabin-crew", label: "Cabin Crew", use: "highlight your safety training, customer-service record and the languages or routes you're experienced with", skillsNote: "List safety/emergency training certifications, language fluency and any customer-service metrics or commendations you've received", example: "A cabin crew applicant listing safety and emergency procedures training plus fluency in three languages" },
  { slug: "resume-builder-for-retail-store-managers", label: "Retail Store Managers", use: "lead with sales targets hit, team size managed and operational improvements you've driven in-store", skillsNote: "Quantify store performance — sales growth, footfall conversion, shrinkage reduction — and list POS/inventory systems you've used", example: "A store manager listing a 22% YoY sales increase while managing a team of 12 across two store sections" },
];
...
const invoiceVariants: { slug: string; label: string; use: string; note: string; example: string }[] = [
  ...
  { slug: "invoice-template-for-real-estate-agents", label: "Real Estate Agents", use: "bill for commission, staging services and marketing costs on a closed deal", note: "itemise commission separately from any marketing or staging costs you're passing through, since clients expect to see the commission calculation clearly", example: "An agent invoicing a 2% commission on a closed sale plus a professional photography add-on" },
  { slug: "invoice-template-for-fitness-trainers", label: "Fitness Trainers", use: "bill for individual sessions, packages or monthly coaching plans", note: "itemise by session count or package (e.g. an 8-session bundle) so clients can see exactly what they paid for", example: "A personal trainer invoicing a monthly 12-session package" },
  { slug: "invoice-template-for-caterers", label: "Caterers", use: "itemise menu items, headcount-based pricing and service staff separately", note: "break the invoice into food cost per head, add-ons (bar service, staffing) and any delivery or setup fee, since clients expect a clear per-guest breakdown", example: "A caterer invoicing a 150-guest wedding reception with a separate staffing line item" },
  { slug: "invoice-template-for-plumbers", label: "Plumbers", use: "itemise labour, parts and call-out fees for a repair or installation job", note: "separate labour, parts and any emergency/call-out fee into distinct line items — customers and insurers both expect this breakdown", example: "A plumber invoicing an emergency pipe repair with separate parts and after-hours call-out fee" },
  { slug: "invoice-template-for-graphic-designers", label: "Graphic Designers", use: "bill for design deliverables, revision rounds and usage rights separately", note: "list each deliverable (logo, brand guide, social templates) as its own line item, and note usage rights or licensing terms if they're part of the deal", example: "A freelance designer invoicing a logo package plus two rounds of revisions and full usage rights" },
  { slug: "invoice-template-for-freelance-writers", label: "Freelance Writers", use: "bill per article, per word or per project with a clean breakdown clients trust", note: "itemise by article or deliverable (with word count or topic noted) rather than one lump sum, so the client can see exactly what each piece cost", example: "A freelance writer invoicing five SEO articles delivered in a monthly retainer" },
  { slug: "invoice-template-for-landscaping-services", label: "Landscaping Services", use: "bill for recurring maintenance or one-time jobs with labour and materials itemised separately", note: "separate labour, materials (plants, mulch, equipment) and any recurring service fee into distinct line items", example: "A landscaping company invoicing a one-time yard cleanup plus a new monthly maintenance plan" },
  { slug: "invoice-template-for-it-support-services", label: "IT Support Services", use: "bill for hourly support, retainers or project-based work with a clear scope", note: "itemise by ticket, hour or retainer period so clients can see exactly what support was delivered", example: "An IT support provider invoicing a monthly retainer plus two out-of-scope emergency call-outs" },
  { slug: "invoice-template-for-salons-and-spas", label: "Salons & Spas", use: "bill for individual services, packages or product add-ons in one clean receipt-style invoice", note: "list each service (cut, colour, treatment) and any retail products sold as separate line items", example: "A salon invoicing a colour and cut service plus a retail shampoo purchase" },
  { slug: "invoice-template-for-packers-and-movers", label: "Packers & Movers", use: "bill for packing, transport, labour and distance-based charges with a transparent breakdown", note: "separate packing materials, labour, transport/distance charges and any insurance or storage fee into distinct line items — customers expect to see exactly what drove the total", example: "A packers-and-movers company invoicing a home relocation with separate packing, labour and transport line items" },
  { slug: "invoice-template-for-electricians", label: "Electricians", use: "itemise labour, parts and call-out fees for a wiring or repair job", note: "separate labour, parts and any emergency/after-hours call-out fee into distinct line items — customers and insurers both expect this breakdown", example: "An electrician invoicing a rewiring job with separate labour and parts costs" },
  { slug: "invoice-template-for-auto-repair-shops", label: "Auto Repair Shops", use: "bill for labour, parts and diagnostics on a vehicle repair with a clear breakdown customers trust", note: "itemise diagnostics, parts and labour hours separately, since customers and insurers expect to see exactly what was charged for each", example: "An auto repair shop invoicing a brake job with separate parts and labour line items" },
  { slug: "invoice-template-for-bookkeeping-and-accounting-services", label: "Bookkeeping & Accounting Services", use: "bill for monthly retainers, one-time filings or hourly advisory work with a clean breakdown", note: "itemise by service (bookkeeping, GST filing, payroll processing) or by retainer period, so clients see exactly what each fee covers", example: "A bookkeeping firm invoicing a monthly retainer plus a one-time annual filing fee" },
  { slug: "invoice-template-for-makeup-artists", label: "Makeup Artists", use: "bill for bridal packages, individual sessions and product add-ons in one polished invoice", note: "list the package or session type as one line item and any add-ons (trials, travel, false lashes) as separate ones", example: "A freelance makeup artist invoicing a bridal package plus a pre-wedding trial session" },
  { slug: "invoice-template-for-driving-instructors", label: "Driving Instructors", use: "bill for individual lessons or lesson packages with a simple, clear breakdown students trust", note: "itemise by number of lessons or as a package (e.g. a 10-lesson bundle), so it's clear exactly what was delivered", example: "A driving instructor invoicing a 10-lesson package for a new student" },
  { slug: "invoice-template-for-pest-control-services", label: "Pest Control Services", use: "bill for one-time treatments or recurring pest control plans with a clear service breakdown", note: "list the treatment type (one-time, quarterly plan) and any specific pest targeted as separate line items, since customers expect to see exactly what was treated", example: "A pest control company invoicing a one-time termite treatment plus a new quarterly maintenance plan" },
  { slug: "invoice-template-for-painters", label: "Painters", use: "itemise labour, paint and materials for an interior or exterior painting job", note: "separate labour, paint/materials and any surface-prep charges into distinct line items — customers expect to see exactly what drove the total", example: "A painting contractor invoicing a 3-bedroom interior repaint with separate labour and paint costs" },
  { slug: "invoice-template-for-handyman-services", label: "Handyman Services", use: "bill for mixed small jobs and call-out visits with a clear, itemised breakdown", note: "list each individual task completed during the visit as its own line item alongside a call-out fee, since customers expect to see exactly what was done", example: "A handyman invoicing a single visit covering a leaky faucet repair, a door hinge fix and a call-out fee" },
  { slug: "invoice-template-for-videographers", label: "Videographers", use: "bill for shoots, editing hours and licensing with a polished, branded invoice", note: "list the shoot package as one line item and editing revisions, raw footage delivery or usage rights as separate add-ons", example: "A freelance videographer invoicing a corporate promo package plus two rounds of edits" },
  { slug: "invoice-template-for-virtual-assistants", label: "Virtual Assistants", use: "bill for hourly support or monthly retainers with a clear breakdown of tasks completed", note: "itemise by task category (inbox management, scheduling, data entry) or by retainer period, so clients see exactly what their hours covered", example: "A virtual assistant invoicing a monthly 20-hour retainer covering inbox and calendar management" },
  { slug: "invoice-template-for-transport-and-logistics", label: "Transport & Logistics Companies", use: "bill for freight runs or recurring transport contracts with distance and load-based charges itemised", note: "separate base freight charge, distance/fuel surcharge and any loading, unloading or detention fee into distinct line items — shippers expect to see exactly what drove the total", example: "A transport company invoicing a recurring interstate freight route with a separate fuel surcharge line item" },
  { slug: "invoice-template-for-security-services", label: "Security Services", use: "bill for guard deployment or recurring security contracts with shifts and headcount clearly itemised", note: "itemise by number of guards, shift type (day/night) and duration, plus any equipment or supervisor charges as separate lines", example: "A security agency invoicing a monthly contract covering 4 guards across two 12-hour shifts" },
  { slug: "invoice-template-for-medical-clinics", label: "Medical Clinics & Practitioners", use: "bill patients for consultations, procedures and any lab work with a clear, itemised breakdown", note: "separate the consultation fee from procedures, tests and any pharmacy or lab charges — patients and insurers both expect this breakdown for reimbursement", example: "A clinic invoicing a consultation fee plus a minor procedure and two lab tests" },
  { slug: "invoice-template-for-software-agencies", label: "Software Development Agencies", use: "bill clients for team-based project work, sprints or ongoing retainers across multiple deliverables", note: "break the invoice down by sprint, milestone or team role (design, development, QA) so clients see exactly what each portion of the fee covered", example: "A software agency invoicing the second of four sprint-based milestone payments for a client app build" },
  { slug: "invoice-template-for-gyms-and-fitness-centers", label: "Gyms & Fitness Centers", use: "bill members for monthly plans, day passes and add-ons like personal training or classes", note: "list the membership tier or pass type as one line item and any add-ons (PT sessions, classes, merchandise) as separate ones", example: "A gym invoicing a monthly premium membership plus a 4-session personal training add-on" },
];
